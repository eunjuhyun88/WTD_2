    ...
    if (eip6963Provider) {
      ...
      try {
        ...
        try {
          ...
          actionError = 'Wallet connected — please switch to Base network manually.';
        }
      ...
      {#if step === 'wallet-select'}
        <div class="wb">
          ...
          {:else if privyStep === 'otp'}
            ...
            <button class="btn-ghost" type="button" onclick={() => { privyStep = 'email'; privyCode = ''; actionError = ''; }}>← CHANGE EMAIL</button>
