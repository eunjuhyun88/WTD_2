<script lang="ts">
  ...
  const examples = $derived([
    ...
    'CVD Divergence auto-detect + alert',
    'Exchange Basis (futures-spot spread)',
  ]);
  ...
  <div class="pine-panel" role="dialog" aria-label="Pine Script Generator">
    ...
    <div class="pine-input-area">
      <textarea
        class="pine-prompt"
        bind:value={prompt}
        placeholder="What indicator would you like to build? e.g. Normalized CVD chart comparing BTC and ETH"
        rows={3}
        onkeydown={handleKey}
        disabled={loading}
      ></textarea>
        ...
        {#if result.usage || result.limitations}
          <div class="pine-notes">
            ...
            {#if result.limitations}
              <div class="pine-note">
                <span class="pine-note-label">Limitations</span>
