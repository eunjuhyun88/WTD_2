<script lang="ts">
  ...
  import MobileSymbolStrip from '../../../shared/panels/mobile/MobileSymbolStrip.svelte';
  import ModeRouter from '../../../shared/panels/mobile/ModeRouter.svelte';
  import MobilePromptFooter from '../../../shared/panels/mobile/MobilePromptFooter.svelte';
  import BottomTabBar from '../../../shared/panels/mobile/BottomTabBar.svelte';
