<script lang="ts">
  ...
  import ChartGridLayout from './ChartGridLayout.svelte';
  import {
    fetchAnalyze,
  ...
  import WorkspacePresetPicker from './WorkspacePresetPicker.svelte';
  ...
  import { buildCogochiWorkspaceEnvelope, buildStudyMap } from '$lib/hubs/terminal/workspaceDataPlane';
...
<style>
  ...
  .lvl-label { font-family: 'JetBrains Mono', monospace; font-size: var(--ui-text-xs); color: var(--g6); letter-spacing: 0.14em; }
