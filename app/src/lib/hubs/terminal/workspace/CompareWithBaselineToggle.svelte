      ...
      <div class="cwb-comparison">
        ...
        <div class="cwb-response-block">
          ...
          <div class="cwb-response-body">
            "BTC is currently trading at $XX,XXX, RSI 60 in
        ...
        <div class="cwb-response-block">
          <div class="cwb-response-header cwb-response-user-header">
            ...
            <span class="cwb-response-sublabel">v3, 60 feedbacks incorporated</span>
          </div>
          <div class="cwb-response-body">
            "The bb_expansion + OI accumulation condition you
            saw before is showing up on BTC 4h now. But unlike
            last time, funding is not overheated — entry looks viable. Stop at 23.8..."
