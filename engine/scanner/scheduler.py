...
_ON = {"1", "true", "yes", "on"}
_OFF = {"0", "false", "no", "off"}
PATTERN_REFINEMENT_ENABLED = os.environ.get("ENABLE_PATTERN_REFINEMENT_JOB", "true").strip().lower() in _ON
...
PATTERN_REFINEMENT_AUTO_TRAIN = os.environ.get("PATTERN_REFINEMENT_AUTO_TRAIN", "true").strip().lower() in _ON
