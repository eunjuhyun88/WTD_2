...
_canonical = "research.artifacts.feature_windows"
_alias = "research.feature_windows"
...
# This means "import research.feature_windows" or "from research import feature_windows"
# will get the SAME object as "import research.artifacts.feature_windows"
_sys.modules[_alias] = _target

# Still export everything for "from research.feature_windows import ..." style
