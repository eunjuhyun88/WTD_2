...
class PatternModelRegistryStore:
    ...
    def list(self, pattern_slug: str) -> list[PatternModelRegistryEntry]:
    ...
    def get_active(self, pattern_slug: str) -> PatternModelRegistryEntry | None:
        return next((entry for entry in self.list(pattern_slug) if entry.rollout_state == "active"), None)

    def get_preferred_scoring_model(self, pattern_slug: str) -> PatternModelRegistryEntry | None:
        entries = self.list(pattern_slug)
