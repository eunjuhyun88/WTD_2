...
**`-1`은 product PRD로, 모든 엔지니어링 문서가 이 PRD 기반으로 작성된다.**

| # | 문서 | 책임 |
|---|---|---|
| **-1** | **`-1_PRODUCT_PRD.md`** | **Why & What — 제품 정체성, 페르소나, 비즈니스, UX 정본** |
...
| 08 | `08_PHASE_PATH_EDIT_DISTANCE_SPEC.md` | Sequence matcher 알고리즘 완전 spec (§03 §4 구체화) |
| 09 | `09_RERANKER_TRAINING_SPEC.md` | LightGBM ranker 학습/검증/배포 완전 spec (§03 §5 구체화) |

**읽는 순서:** 신규 진입자는 `-1` → `00` → 본인 영역 (`01`~`07`).
...
- **제품 PRD (Why & What, 페르소나, 비즈니스, UX): `-1_PRODUCT_PRD.md`**
