...
| M3 | **PassportMiniCard** — Win Rate + Total PnL + Open Trades + Tracked Signals | 이미 polling 중인 `/api/profile/passport` | Hero Tier 카드 확장 | **High** — 추가 fetch 0, /passport 와 중복 아님 (요약 vs 상세) |
