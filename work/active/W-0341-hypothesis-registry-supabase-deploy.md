...
## Exit Criteria
- [ ] AC1: slug 2회 등록 → count=2
- [ ] AC2: family 격리 SELECT (family_a 결과에 family_b slug 미포함)
- [ ] AC3: 366일 archive purge (as_of 기준)
- [ ] AC4: as_of=None → ValueError
- [ ] AC5: prod Supabase hypothesis_registry 테이블 deployed (migration 027)
- [ ] AC6: 4 integration tests GREEN (실 DB 연결)
