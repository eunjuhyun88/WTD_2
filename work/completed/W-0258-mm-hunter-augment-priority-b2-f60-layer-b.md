...
| 리스크 | 확률 | 영향 | 완화 |
|---|---|---|---|
| `require_subjective_gate=False` default가 production 무영향 보장 | 낮 | 상 | 기존 52 PatternObject 회귀 테스트 (default=False 시 통과율 동일) |
...
- Layer B만 통과 (Layer A 실패) 시 promotion 결정 — 52 PatternObject 시뮬레이션
