...
- 신규 마이그레이션 `033_propfirm_p1_core.sql`: `trading_accounts`, `orders`, `positions`, `fills`, `daily_performance`, `pattern_fires`
...
| W-# | 제목 | Effort |
|---|---|---|
| W-PF-101 | `033_propfirm_p1_core.sql` 통합 스키마 (trading_accounts/orders/positions/fills/pattern_fires) | S |
...
|---|---|---|---|---|
| P1 | W-PF-101 | `033_propfirm_p1_core.sql` 통합 스키마 (pattern_fires 포함) | S | - |
